...
-   Research:
    ...
    -   Using Big data for allocating funding
:::
...
[![Tools for Systems Thinkers: The 6 Fundamental Concepts of Systems Thinking](img/system_think.png){fig-align="center" width="921" height="553"}](https://medium.com/disruptive-design/tools-for-systems-thinkers-the-6-fundamental-concepts-of-systems-thinking-379cdac3dc6a)
...
[![Updated from Grolemund & Wickham\'s classis R4DS schematic, envisioned by Dr. Julia Lowndes for her 2019 useR! keynote talk and illustrated by Allison Horst. Source: Allison Horst data science and stats illustrations](img/environmental_data_science_r4ds_general.png){fig-align="center" width="634" height="343"}](https://github.com/allisonhorst/stats-illustrations)
...
::: columns
::: {.column width="49%"}
![](img/woolstore.png){fig-align="center" width="423"}

![](img/woolstore_2.png){fig-align="center" width="430"}
:::

::: {.column width="49%"}
![](img/woolstore_3.png){fig-align="center" width="467"}
:::
:::
...
::: {.column width="49%"}
![](img/globe.png){fig-align="center" width="305"}

[![Coordiante reference systems](img/projected.png){fig-align="center" width="300"}](https://r.geocompx.org/spatial-class.html)
:::
:::
...
[![Spatial Data](img/geometry_col.png){fig-align="center" width="546" height="244"}](https://manifold.net/doc/mfd9/spatial_data.htm)
...
-   1930s -- American Home Owner's Loan Corporation -- prevent missed payments...residential security maps **based on race**
    ...
    -   Illegal since 1968 Fair Housing Act
:::
...
::: {.column width="49%"}
[![Gerrymandering](img/gerrymandering.png){fig-align="center" width="275"}](https://en.wikipedia.org/wiki/Gerrymandering)
:::
:::
...
![](img/parquet-logo.png){height="150px" fig-align="center"}
...
[![New York City Taxi and Limousine Commission (TLC) all records from Yellow and Green Cabs](img/cab_data.png){fig-align="center" width="17.7cm" height="13.9cm"}](https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.pag)
...
![](img/duck.jpg){fig-align="center" width="402"}
...
[![DVD Rental Model](img/dvd-rental-sample-database-diagram.png){fig-align="center" width="408" height="538"}](https://www.postgresqltutorial.com/postgresql-getting-started/postgresql-sample-database/)

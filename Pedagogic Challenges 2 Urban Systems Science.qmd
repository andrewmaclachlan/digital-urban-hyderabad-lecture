...
[![Updated from Grolemund & Wickham's classis R4DS schematic, envisioned by Dr. Julia Lowndes for her 2019 useR! keynote talk and illustrated by Allison Horst. Source: Allison Horst data science and stats illustrations](img/environmental_data_science_r4ds_general.png){fig-align="center"}](https://github.com/allisonhorst/stats-illustrations)
...
[![Coordiante reference systems](img/projected.png){fig-align="center" width="308"}](https://r.geocompx.org/spatial-class.html)
:::
:::
...
::: {.column width="49%"}
[![Gerrymandering](img/gerrymandering.png){fig-align="center" width="300"}](https://en.wikipedia.org/wiki/Gerrymandering)
:::
:::

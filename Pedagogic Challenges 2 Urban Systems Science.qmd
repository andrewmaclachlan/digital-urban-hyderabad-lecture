...
![](img/system_think.png){fig-align="center" width="350"}
...
## Smart cities {auto-animate="true"}

<br/>

**United Nations Thematic Areas**

-   Inclusive cities - equal access to services, increase safety

-   Sustainable cities - limited resources in most efficient manner

-   Adaptable cities - mitigate and adapt, air pollution, climate change

::: {style="font-size: 60%;"}
Source: [Smart Cities](https://www.undp.org/sgtechcentre/smart-cities-1#:~:text=Smart%20cities%20use%20technology%20and,as%20a%20leading%20smart%20city.)
:::
...
::: columns
::: {.column width="49%"}
![](img/woolstore.png){fig-align="center" width="594"}

![](img/woolstore_2.png){fig-align="center" width="548"}
:::

::: {.column width="49%"}
![](img/woolstore_3.png){fig-align="center" width="548"}
:::
:::
...
![](img/woolstore_plans.png){fig-align="center" width="548"}
...
![](img/planning_process.png){fig-align="center" width="1000"}
...
<iframe width="900" height="700" src="https://www.youtube.com/embed/k5eL_al_m7Q?start=3" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
...
::: {.column width="49%"}
![](img/globe.png){fig-align="center" width="401"} ![](img/projected.png){fig-align="center" width="400"}
:::
:::

## 

![](img/flat_earth.png){fig-align="center" width="401"}

## Simply

> Spatial data is just like normal data exepct it has an extra "geometry column"

[![Spatial data. Source: Manifold Viewer](img/geometry_col.png)](https://manifold.net/doc/mfd9/spatial_data.htm)
...
**Data can often misrepresented, even from *trusted* sources**
...
-   It groups our data. For example a row group size of 2, puts rows all the data from 1 and 2 next to each other **then** we have 3! = GROUPS or PARTITION
...
[![New York City Taxi and Limousine Commission (TLC) all records from Yellow and Green Cabs](img/cab_data.png){fig-align="center" width="2000"}](https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.pag)

## Concepts

-   You may come across **Arrow** - this is an in-memory format, **Parquet** is a storage format

-   The primary difference in using this is we write some code then apply the code to the storage files

-   Afterwards we **collect** the results...
...
\[![DuckDB](img/duck.jpg){fig-align="center" width="2000"}\]
...
-   All make sure of `dplyr` ! `select()`, `filter()`, `groupby()` = direct integration with R
...
-   Currently the support for spatial data is very limited limited
...
![](img/Postgresql_elephant.svg.png){fig-align="center" width="482"}

## PostGIS

-   PostgreSQL = object-relational database

[![DVD Rental Model](img/dvd-rental-sample-database-diagram.png){fig-align="center" width="793"}](https://www.postgresqltutorial.com/postgresql-getting-started/postgresql-sample-database/)
...
[![](img/random_points.png){fig-align="center" width="100%"}](https://freegistutorial.com/how-to-create-random-points-inside-polygon-on-qgis/)
...
![](img/PostGIS_logo.png){fig-align="center"}
...
![](img/QGIS.png){fig-align="center" width="773"}

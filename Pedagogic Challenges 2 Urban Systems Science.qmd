...
![](img/canada_election.png){fig-align="center" width="70%"}
...
[![New York City Taxi and Limousine Commission (TLC) all records from Yellow and Green Cabs](img/cab_data.png){fig-align="center" width="80%"}](https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.pag)
...
![](img/duck.jpg){fig-align="center" width="75%"}
...
[![DVD Rental Model](img/dvd-rental-sample-database-diagram.png){fig-align="center" width="45%"}](https://www.postgresqltutorial.com/postgresql-getting-started/postgresql-sample-database/)
...
![](img/random_points.png){fig-align="center" width="31%"}
